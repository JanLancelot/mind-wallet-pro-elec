...
const moodIcons: Record<Mood, React.ReactNode> = {
  excited: <PartyPopper className="w-6 h-6 text-green-500" />,
  happy: <Heart className="w-6 h-6 text-blue-500" />,
  neutral: <Circle className="w-6 h-6 text-yellow-500" />,
  unhappy: <Cloud className="w-6 h-6 text-orange-500" />,
  regret: <CloudRain className="w-6 h-6 text-red-500" />,
};
